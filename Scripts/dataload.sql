    ...
    INSERT INTO Leilao (data_inicio, data_fim, hora_fim, detalhe, valor_inicial, status, dados_status, id_cooperativa) VALUES 
    ('2024-08-28', '2024-09-01', '15:00:00', 'detalhes', 1000.0, TRUE, TRUE, '12345678901234'),
    ('2024-09-10', '2024-09-15', '10:20:00', 'detalhes', 2000.0, TRUE, TRUE, '23456789065489'),
    ('2024-09-20', '2025-01-10', '00:09:00', 'detalhes', 3000.0, TRUE, TRUE, '34567890123456'),
    ('2024-10-25', '2024-10-27', '12:10:00', 'detalhes', 4000.0, TRUE, TRUE, '45678901234586'),
    ('2024-05-12', '2024-06-02', '09:45:00', 'detalhes', 5000.0, TRUE, TRUE, '56789012345678'),
    ('2024-11-20', '2024-12-17', '17:50:00', 'detalhes', 6000.0, TRUE, TRUE, '67890123456789');
